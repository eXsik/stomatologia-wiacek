...
/**
 * Keep CPT boxes visible by default in Appearance → Menus.
 *
 * @param string[]   $hidden Hidden meta box IDs.
 * @param WP_Screen $screen Current screen.
 * @return string[]
 */
function sw_nav_menus_default_visible_cpts( $hidden, $screen ) {
	...
	$cpt_boxes = array(
		...
		'add-post-type-team_member',
		'add-post-type-testimonial',
		'add-post-type-faq',
	);

	return array_values( array_diff( (array) $hidden, $cpt_boxes ) );
}
add_filter( 'default_hidden_meta_boxes', 'sw_nav_menus_default_visible_cpts', 10, 2 );
add_filter( 'hidden_meta_boxes', 'sw_nav_menus_default_visible_cpts', 10, 2 );
