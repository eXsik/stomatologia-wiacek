...
acf_add_local_field_group( array(
	...
	'fields'   => array(
		...
		array(
			...
			'allow_null'    => 1,
			'ui'            => 1,
			'instructions'  => 'Zdjęcie na froncie = Obrazek wyróżniający wybranego wpisu w Zespół (nie strony głównej).',
		),
	),
	'location' => array(
		array(
...
acf_add_local_field_group( array(
	...
	'fields' => array(
		...
		array(
			...
			'label'        => 'Korzyści (lista)',
			'name'         => 'service_benefits',
			'type'         => 'textarea',
			'rows'         => 5,
			'instructions' => 'Jedna korzyść w linii, np.:„Naturalny wygląd” / „Trwała funkcja zgryzu”. Pokazuje się jako lista na stronie usługi.',
		),
		array(
			'key'          => 'field_service_for_whom',
			'label'        => 'Dla kogo?',
			'name'         => 'service_for_whom',
			'type'         => 'textarea',
			'rows'         => 3,
			'instructions' => 'Krótki akapit: kiedy warto rozważyć tę usługę.',
		),
	),
	'location' => array(
		array(
